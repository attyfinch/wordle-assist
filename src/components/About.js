...
export default function About() {
    ...
    return (
        ...
        <div className="about-page">
            ...
            <div className="about-block">
                Here's a brief explanation of how each filter field works.
            </div>
            <div className="about-block">
            ...
            <div className="about-block">
                ...
                <div>Each field corresponds to a position in the word. For example, L1 refers to position 1, L2 to position 2 and so on. Place letters here that you know the word contains, but do not know the exact position of. As an example, imagine you know the word contains the letter A, but you know that it is not L1 or L2. You would put the letter A in these two fields. All words where letter A appears at these positions will be eliminated from results returned.</div>
            </div>
            <div className="about-block">
